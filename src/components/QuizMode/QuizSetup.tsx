    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              ...
              className="flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
              <Play className="w-5 h-5" />
              <span>Start Quiz</span>
            </button>
            <button
              className={`flex items-center justify-center space-x-2 px-6 py-3 rounded-lg border text-sm font-medium shadow-sm transition-colors ${bookmarkedIds.length === 0 ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed' : 'bg-blue-100 text-blue-700 border-blue-300 hover:bg-blue-200'}`}
        ...
        <div className="flex flex-wrap gap-4 mt-2">
          <span className="flex items-center space-x-2 text-blue-700 text-sm font-medium bg-blue-50 px-3 py-1 rounded-lg"><Clock className="w-4 h-4" />Timed Practice</span>
          <span className="flex items-center space-x-2 text-green-700 text-sm font-medium bg-green-50 px-3 py-1 rounded-lg"><Brain className="w-4 h-4" />AI Review</span>
        </div>
      </div>
